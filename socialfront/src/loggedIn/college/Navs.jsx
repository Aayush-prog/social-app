...
export default function Navs() {
  ...
  const handleSettingsClick = async () => {
    navigate(`/clg/settings/${profileData._id}`);
  };
  ...
  return (
    ...
    >
      ...
      <Navbar.Collapse>
        <NavLink to="/clg/home" className="flex gap-2 place-items-center">
          <FiHome />
          <span>Home</span>
        </NavLink>
        <NavLink to="/clg/event" className="flex gap-2 place-items-center">
          <LuCalendar />
          <span>Events</span>
        </NavLink>
        <NavLink to="/clg/module" className="flex gap-2 place-items-center">
          <MdOutlineLibraryBooks />
          <span>Modules</span>
        </NavLink>
        <NavLink to="/clg/grp" className="flex gap-2 place-items-center">
          <MdOutlineGroups />
          <span>Groups</span>
        </NavLink>
      </Navbar.Collapse>
